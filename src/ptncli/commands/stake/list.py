...
async def run_stake_list(
    ...
    try:
        ...
        console.print(f"[red]❌ Error listing stakes: {e}[/red]")
        return False
...
def list_command(
    wallet_name: str = typer.Option(
        None,
        "--wallet.name",
        help="Name of the wallet to list stakes for",
    ),
    ...
    coldkey_ss58: Optional[str] = typer.Option(
        None,
        "--coldkey_ss58",
        help="Coldkey SS58 address to list stakes for",
    ),
    live: bool = typer.Option(
        False,
        "--live",
        help="Enable live monitoring of stakes",
    ),
